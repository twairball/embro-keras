...
if __name__ == '__main__':
    ...
    ## TODO: save model params to yaml separately of checkpoint
    ## Load model defaults for now
    pastiche_net = pastiche_model(256, width_factor=2,
                                  nb_classes=1,
                                  targets=class_targets)

    print("loading weights...")
    pastiche_net.load_weights(args.checkpoint_path)
    ...
    num_batches = int(np.ceil(1 / float(args.batch_size)))
